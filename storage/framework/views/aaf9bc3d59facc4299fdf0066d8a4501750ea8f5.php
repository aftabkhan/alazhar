...
<footer id="footer" class="position-relative pt-5 pb-5">
    <div class="footer-left-bg position-absolute"><img src="<?php echo e(asset('public/imgs/footer-left-bg.png')); ?>" alt="" height="200"></div>
    <div class="footer-right-bg position-absolute"><img src="<?php echo e(asset('public/imgs/footer-right-bg.png')); ?>" alt="" height="200"></div>
    <div class="container">
        <div class="row">
            <div class="col-lg-4"> <img src="<?php echo e(asset('public/imgs/white-logo.png')); ?>" height="70" alt="" class="mb-3">
                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="list-inline d-flex justify-content-md-between bottom mt-lg-2">                                
                            <li class="list-inline-item"><a href="<?php echo e(route('news')); ?>">News &amp; Updates</a></li>
                            <li class="list-inline-item"><a href="#">Privacy Policy</a></li>
                            <li class="list-inline-item"><a href="<?php echo e(route('showContactUsForm')); ?>">Contact Us</a></li>
               ...
               <div class="row mt-lg-2">
                   <div class="col-12">                           
                        <ul class="list-inline footer-social-links">                            
                            <li class="list-inline-item"><a href="https://www.facebook.com"><img class="svg" src="<?php echo e(asset('public/imgs/logo-facebook.svg')); ?>" alt="" height="36"></a></li>
                            <li class="list-inline-item"><a href="https://www.twitter.com"><img class="svg" src="<?php echo e(asset('public/imgs/logo-twitter.svg')); ?>" alt="" height="36"></a></li>
                            <li class="list-inline-item"><a href="https://www.linkedin.com"><img class="svg" src="<?php echo e(asset('public/imgs/logo-linkedin.svg')); ?>" alt="" height="36"></a></li>
                            <li class="list-inline-item"><a href="https://www.youtube.com"><img class="svg" src="<?php echo e(asset('public/imgs/logo-youtube.svg')); ?>" alt="" height="36"></a></li>
                        </ul>
                   </div>
               </div>
            </div>
...
<script src="<?php echo e(asset('public/js/bootstrap.min.js.map')); ?>"></script>
