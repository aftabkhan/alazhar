        ...
        <div class="section-body">
                <div class="card">
                    <div class="card-header">
                        ...
                        <?php endif; ?>
                        <form class="w-100" action = "<?php echo e(url('departments/update')); ?>/<?php echo e($department_det->id); ?>" method = "post"files='false' enctype="multipart/form-data">
                            	<?php echo csrf_field(); ?>
					            <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="form_name">Name (English)<small>*</small></label>
                                        <input  name="name_en" class="form-control" type="text" placeholder="Enter Name" required="" aria-required="true" value= "<?php echo e($department_det->name_en); ?>">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input name="name_ar" class="form-control" type="text" placeholder="Enter Name" required="" aria-required="true" value= "<?php echo e($department_det->name_ar); ?>">
