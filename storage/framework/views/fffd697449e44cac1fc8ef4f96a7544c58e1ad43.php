...
<body>
        ...
        <?php echo $__env->make('layouts.nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
            ...
            <section class="p-0">
                <div class="section-container container">
                    <div class="section-banner section-about text-white">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h1 class="section-title"><?php echo app('translator')->getFromJson('labels.available_vacancies'); ?></h1>
                                <h4 class="section-para"><?php echo app('translator')->getFromJson('labels.career'); ?></h4> </div>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->getFromJson('labels.available_vacancies'); ?></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <section class="pt-3 pb-3">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="page-head">
                                <h2><?php echo app('translator')->getFromJson('labels.available_vacancies'); ?></h2> </div>
                        </div>
                    </div>
                    <div class="row pt-3">
                        <div class="col-md-4">
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="media bg-deep p-4 mb-2">
                                        <form action="">
                                           <h5 class="h5"><?php echo app('translator')->getFromJson('labels.job_search'); ?></h5>
                                            <div class="form-row">
                                                <div class="form-group col-12">
                                                    <input type="text" class="form-control" id = "job_id" placeholder="<?php echo app('translator')->getFromJson('labels.key_words'); ?>"> 
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-12">
                                            ...
                                            <div class="btn btn-green-outline btn-sm" id = "jobs_search_button"><?php echo app('translator')->getFromJson('labels.search'); ?></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- end main-content -->
            <script type="text/javascript" charset="utf8" src="<?php echo e(asset('public/js/loadmore.js')); ?>"></script>
