    ...
    <body>
        ...
        <div class="section-container container">
            <div class="section-banner section-about text-white">
                ...
                <div class="row">
                    <div class="col-12">
                        <h1 class="section-title"><?php echo app('translator')->getFromJson('labels.appointment'); ?></h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->getFromJson('labels.appointment_booking'); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="pt-3 pb-3">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="page-head">
                                <h2><?php echo app('translator')->getFromJson('labels.book_appointment'); ?></h2> 
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            ...
                            <form id="contact_form" name="contact_form" class="contact_form" action="<?php echo e(route('storeAppointment')); ?>" method="post" novalidate="novalidate">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="form_phone"><?php echo app('translator')->getFromJson('labels.phone'); ?> <small>*</small></label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="form_name"><?php echo app('translator')->getFromJson('labels.sel_dept'); ?></label>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="form_name"><?php echo app('translator')->getFromJson('labels.sel_doc'); ?></label>
                                            <select name="doctor_id" id="doctor_id" class="form-control">
                                            </select>
                                            <?php if(!empty($errors->has('doctor_id'))): ?>
                                                <div class="row col-lg-12">
                                                    <div class="alert alert-danger">
                                                        <span><?php echo e($errors->first('doctor_id')); ?></span>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="form_name"><?php echo app('translator')->getFromJson('labels.appointment_for_date'); ?> <small>*</small></label>
                                            <input id="datetimepicker" name="appointment_date" class="form-control" type="text" placeholder="<?php echo app('translator')->getFromJson('labels.pick_date'); ?>" required="" aria-required="true">
                                ...
                                <div class="form-group">
                                    <label for="form_name"><?php echo app('translator')->getFromJson('labels.why_appointment'); ?> <small>*</small></label>
                                    <textarea id="form_message" name="appointment_reason" class="form-control required" rows="5" placeholder='<?php echo app('translator')->getFromJson('labels.enter_message'); ?>' aria-required="true"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-green mr-2"><?php echo app('translator')->getFromJson('labels.book_appointment'); ?></button>
